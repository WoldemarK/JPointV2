...
public class DepartmentController {
    ...
    public ResponseEntity<List<DepartmentDto>> getAll() {
        List<DepartmentDto> _departments = new ArrayList<>(service.getAllDepartments());
    ...
    public ResponseEntity<List<DepartmentDto>> searchNames(@RequestParam String name) {
        return new ResponseEntity<>(service.getDepartmentsName(name), HttpStatus.OK);

    }

    @GetMapping("/search/start_name")
    public ResponseEntity<List<DepartmentDto>> searchStartNames(@RequestParam String name) {
    ...
    public void update(@RequestBody DepartmentDto departmentDto, @PathVariable("id") Long id) {
        service.updateDepartments(departmentDto, id);
    }
